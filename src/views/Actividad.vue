  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conocimiento y recuerdo sobre la gestión de servicios en la nube
        p.mb-4 Identificar algunas palabras y conceptos relacionados con la Gestión de los servicios en la nube.
